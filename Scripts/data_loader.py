...
class DataLoad:
    ...
    def read_csv_txt_data(self):
        ...
        # Define file paths
        file_paths = [
            os.path.join(src_dir, 'sheger.txt'),
            os.path.join(src_dir, 'zemen.csv'),
            os.path.join(src_dir, 'nevacomputer.csv'),
            os.path.join(src_dir, 'Shewabrand.csv'),
            os.path.join(src_dir, 'modernshoppingcenter.csv'),
            os.path.join(src_dir, 'marakibrand.csv'),
            ...
            os.path.join(src_dir,'kuruwear.csv'),
            os.path.join(src_dir,'qnashcom.csv'),
        ]
